...
function VerticalDivider({ disableVertical }) {
  ...
  return (
    <Stack sx={{ height: '30%', alignItems: 'center', gap: '-2px' }}>
...
function EventIcon({ src, justifyContent }) {
  ...
  return (
    <IconImg
      src={src}
      sx={{ display: 'flex', width: isPhone ? '37.5vw' : '25vw', padding: isPhone ? '4px' : '8px', justifyContent, alignItems: 'center', gap: '8px' }}
...
function EventContentWrapper({ children, alignItems }) {
  ...
  return (
    <Stack sx={{
      width: isPhone ? '37.5vw' : '25vw',
      padding: isPhone ? '4px' : '0px',
...
export function TimelineSession() {
  ...
  return (
    <Stack
      sx={{ padding: isPhone ? '16px 0 0' : '64px 460px 0', margin: 'auto', width: isPhone ? '380px' : '100%', height: isPhone ? '100vh' : '100%' }}
      alignItems='center'
    ...
    >
      ...
      <Stack alignItems='center'>
        <Box height= '30%' sx={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }} >
          <EventIcon src="/icons/record.svg" justifyContent="flex-end" />
          <VerticalDivider />
          <EventContentWrapper alignItems="flex-start">
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '8px', flexDirection: isPhone ? 'column' : 'row' }}>
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>09:00 SÁNG</Typography>
              {isPhone ? null : (<Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>:</Typography>)}
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>ĐÓN KHÁCH</Typography>
            </Box>
            <EventDecs justifyContent="flex-start" textAlign='left'>Sự hiện diện quý giá</EventDecs>
            <EventMessage alignItems="flex-start">
        ...
        <Box height= '30%' sx={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }} >
          <EventContentWrapper alignItems="flex-end">
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px', flexDirection: isPhone ? 'column' : 'row' }}>
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>09:30 SÁNG</Typography>
              {isPhone ? null : (<Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>:</Typography>)}
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>LÀM LỄ</Typography>
            </Box>
        ...
        <Box height= '30%' sx={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }} >
          ...
          <EventContentWrapper alignItems="flex-start">
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap: '8px', flexDirection: isPhone ? 'column' : 'row' }}>
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>10:30 SÁNG</Typography>
              {isPhone ? null : (<Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>:</Typography>)}
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>NHẬP TIỆC</Typography>
            </Box>
        ...
        <Box height= '30%' sx={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }} >
          <EventContentWrapper alignItems="flex-end">
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '8px', flexDirection: isPhone ? 'column' : 'row' }}>
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>12:00 SÁNG</Typography>
              {isPhone ? null : (<Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>:</Typography>)}
              <Typography variant="headline2" textAlign='center' color={theme.palette.neutral.dark}>GIAO LƯU VĂN NGHỆ</Typography>
            </Box>
